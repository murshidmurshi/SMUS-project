...
function DemoCard() {
  ...
  const handleGoProfile = () => {
    console.log("fdskbf");
    navigate('/teacherhome/createProfile')
  }
...
<Grid sx={{ margin: 2, marginTop: 13 }}>
  <Card style={cardStyle} variant="outlined">
    ...
    <CardMedia
      component="img" // specify that the media is an image
      height="140" // adjust the height as needed
      image="https://img.freepik.com/free-photo/fun-3d-cartoon-teenage-boy_183364-81177.jpg?t=st=1711274362~exp=1711277962~hmac=a7a1afc0d01308d998b53c5956ab95b1e62dafaaafdd88bafe0932a92496cf06&w=360" // replace with the URL of your image
      alt="Profile Image" // specify alt text for accessibility
      sx={{ width:100 }} // rotate the image 90 degrees clockwise
...
export default function TeacherHome() {
  ...
  React.useEffect(() => {
    ...
    axios.get('http://localhost:3000/api/teacher/userid', {
      ...
      .then(response => {
        setTeacherDetail(response.data.teacherDetail);
      })
      .catch(error => {
...
<>
        ...
        <Grid container spacing={2} sx={{ marginTop: 10, justifyContent: "flex-end", marginLeft: -3 }}>
          <Grid item>
            {/* Timetable Icon */}
            <IconButton color="primary" aria-label="timetable" onClick={()=>navigate('/teacherhome/timetablelist')}>
              <BackupTableIcon  />
            </IconButton>
          </Grid>
          <Grid item>
...
<Grid>
  <TeacherTimetable  teacherDetail={teacherDetail}  />
</Grid>
</>
      )}
